...
historical_figure.each do |item|
  ...
  t.ent_pop_link = iem[:ent_pop_link]
end
...
historical_event_collection.each do |item|
  ...
  t.name = item[:name]
  t.aggressor_dd_ent_id = item[:aggessor_id]
  t.defender_ent_it = item[:defender_ent_it]
  t.ware_eventcol = item[:war_eventcol]
  ...
  t.attacking_squad_entity_pop = item[:attacking_squad_entity_race]
  t.attacking_squad_number = item[:attacking_squad_number]
  t.attacking_squads = item[:attacking_squad]
  t.defending_squads = item[:defending_squad]
